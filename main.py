...
def _print_usage_guide(show_examples: bool = True, show_usage: bool = True) -> None:
    lines: list[str] = [
        ...
        "  gmail <preset> s ...",
        "    send a new email, optionally with cc, bcc, attachments, or editor mode",
        "  gmail <preset> ls ...",
        "    search, list, or audit messages",
        "  gmail <preset> r ...",
        "    reply to a message or thread",
        "  gmail <preset> o ...",
        "    open a message or thread in the terminal",
        "  gmail <preset> mr | mur | mstr | mustr | d | ms",
        "    mark read, unread, star, unstar, delete, or mark sender as spam",
        "  gmail <preset> si | sc | sa | se",
        "    inspect spam, clean spam, add spam senders, or exclude trusted senders",
        "  gmail <preset> cn",
        "    list, add, delete, or edit contact aliases",
        "  gmail sc | ti | td | st",
        "    run global spam cleanup or manage the hourly timer",
    ]
    if show_examples:
        lines.extend(
            [
